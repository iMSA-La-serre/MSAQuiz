...
On a `"shortanswer"`, the inputs that matched no accepted answer are `totalAnswered - correctCount`; `SHOW_RESPONSES` never carries the texts players typed. On a `"wordcloud"`, `words` never says who typed a word.
