...
| `SHOW_RESULT`   | `{ correct: boolean, message: string, points: number, myPoints: number, rank: number, aheadOfMe: string \| null }`                                            | Whether your submitted answer was correct, points earned, and your new total/rank. On a `"poll"`, `correct` only means "your vote was recorded", and `message` is `game:pollAnswered` or `game:pollNoVote`.                                                                                                                                                                     |
