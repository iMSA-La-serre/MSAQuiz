...
Once a question closes, only the manager receives `SHOW_RESPONSES`: the question itself (with `solutions`, `accepted` for a `"shortanswer"`, `expected` and `options` for an `"estimate"`, `text` for a `"highlight"`) plus these fields.

| Field           | Meaning                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| --------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `responses`     | Counts keyed by index. Choice types: votes per answer (a `"highlight"`: players who tapped each passage). `"ordering"`: players who put item `i` at its place, `i` indexing `answers`, which is in the correct order here. `"shortanswer"`: inputs recognized per accepted answer.                                                                                                                                                       |
...
| `partialCount`  | Scored types only: answers with some credit, not all (an `"ordering"` partly right, a `"multi"` or a `"highlight"` in a partial mode).                                                                                                                                                                                                                                                                                                   |
