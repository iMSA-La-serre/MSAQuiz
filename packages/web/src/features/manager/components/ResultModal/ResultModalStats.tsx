...
const ResultModalStats = () => {
  const { questionResult, correctPct, answeredCount, totalPlayers } =
    useResultModal()
  const { t } = useTranslation()
  // A poll or a word cloud has no right answer: « Non noté », as in the
  // statistics, rather than 0 % of right answers.
  const { scored } = QUESTION_TYPE_META[questionResult.type]
